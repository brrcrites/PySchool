...
mass1_input = raw_input("Enter first planet's mass: ")
mass2_input = raw_input("Enter second planet's mass: ")
distance_input = raw_input("Enter the distance between the planets: ")
